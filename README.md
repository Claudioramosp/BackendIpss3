# ProviEmplea — API REST de Backend

Backend de la plataforma **ProviEmplea**, un sistema de intermediación laboral que conecta personas en búsqueda de empleo con empresas que ofrecen vacantes. Construido con **Laravel 11**, contenedorizado con **Docker** y documentado con **Swagger/OpenAPI 3.0**.
...
- **Git**
- Puertos **8080** y **3306** libres en tu máquina
...
Edita el archivo `.env` y asegúrate de que las variables de base de datos coincidan con las de `docker-compose.yaml`:
...
Una vez que los contenedores estén corriendo, la documentación interactiva está disponible en:
...
| `L5_SWAGGER_GENERATE_ALWAYS` | Regenerar Swagger en cada solicitud | `true` (desarrollo) |
